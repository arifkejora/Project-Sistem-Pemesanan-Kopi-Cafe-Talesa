...
<html>
<head>
<title>Cafe Talesa - Keranjang Saya</title>
...
<body>
	...
	<div class="logo_products">
		...
		<ul class="phone_email">
				<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : +62852-2752-9450</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">cafe talesa</a></h1>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					<h3>Hubungi Kami</h3>
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Klaten</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">cafe.talesa@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 852-2752-9450</li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
